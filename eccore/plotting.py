...
Docs: https://vtecftwy.github.io/eccore/02_plotting.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs-dev/0_02_plotting.ipynb.

# %% ../nbs-dev/0_02_plotting.ipynb #3eec9daa
...
# %% ../nbs-dev/0_02_plotting.ipynb #3326a672
cmaps = OrderedDict()
...
# %% ../nbs-dev/0_02_plotting.ipynb #060d330e
...
# %% ../nbs-dev/0_02_plotting.ipynb #b4ee89e6
def plot_color_bar(
    ...
    Technical note:
        Adapts the label color to the background color for readibility. 
        To do so it computes the relative luminance as:
            L = 0.2126 * R + 0.7152 * G + 0.0722 * B
            Use black text when L > 0.5, otherwise white text.
    """
    ...
    ax.imshow(gradient, aspect='auto', cmap=cmap_obj)
    denom = max(n_elements - 1, 1)
    for i, val in enumerate(series):
        r, g, b, _ = cmap_obj(i / denom)
        luminance = 0.2126 * r + 0.7152 * g + 0.0722 * b
        text_color = '#000000' if luminance > 0.5 else '#ffffff'
        ax.text(i, .7, str(val), color=text_color, fontsize='medium', fontweight=500, horizontalalignment='center')

    ax.set_xticks(series)
    ax.set_axis_off()
    plt.show()

# %% ../nbs-dev/0_02_plotting.ipynb #3cc14ca8
...
# %% ../nbs-dev/0_02_plotting.ipynb #a071fd93
